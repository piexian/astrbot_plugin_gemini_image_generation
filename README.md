...
#### 预设模式
```bash
# 快速生成各种类型的图像（使用预设的分辨率和长宽比）
/生图 快速模式 头像 生成一个专业的个人头像          # 1K分辨率，1:1比例
```
```
/生图 快速模式 海报 制作一个游戏宣传海报          # 2K分辨率，16:9比例
```
```
/生图 快速模式 壁纸 生成4K高清桌面壁纸            # 4K分辨率，16:9比例
```
```
/生图 快速模式 卡片 设计商务风格名片              # 1K分辨率，3:2比例
```
```
/生图 快速模式 手机 制作手机壁纸                  # 2K分辨率，9:16比例
```
